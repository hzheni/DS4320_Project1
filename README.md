...
|------------|-------------|-------------|
| Fires | This is the main table containing information about individual wildfire records in California, including size (acres burned), duration, and other fire-specific characteristics. It links to Cause, Weather, and Time tables via foreign keys. | [Fires.parquet](_______) |
| Causes | This table contains unique fire causes, with a mapping from numeric cause codes to descriptive names. It serves as lookup table describing the cause of each wildfire, including both detailed cause names and broader classifications (e.g., human vs natural). | [Causes.csv](_______) |
| Weather | This table information about approximate weather conditions at the time of each fire, including temperature, precipitation, and wind speed. | [Weather.csv](_______) |
| Time | This table contains time-related attributes derived from the fire alarm dates, including year, month, season, and other temporal features. It allows for temporal analysis of wildfire patterns. | [Time.csv](_______) |
